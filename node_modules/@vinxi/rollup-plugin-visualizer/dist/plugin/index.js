        ...
        async generateBundle(outputOptions, outputBundle) {
            ...
            for (const [bundleId, bundle] of Object.entries(outputBundle)) {
                ...
                if (opts.sourcemap) {
                    ...
                    const lengths = await ModuleLengths({ id: bundleId, renderedLength: 100, code: bundle.code });
                    tree = (0, data_1.buildTree)(bundleId, lengths, moduleRenderInfo, mapper);
                }
                else {
                    ...
                    const lengths = await ModuleLengths({ id: bundleId, renderedLength: 100, code: bundle.code });
                    tree = (0, data_1.buildTree)(bundleId, lengths, modules, mapper);
                }
